...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_PPPC,_______,KC_ALTKN,KC_GUIEI,KC_ENTRO,KC_ENTRO,KC_SPCRI,KC_SPCRI,KC_LOWEI,  KC_LEFT, KC_DOWN, KC_RIGHT
),
/* Lowerop
 * ,-----------------------------------------------------------------------------------.
 * |   ~  |   !  |   @  |   #  |   $  |   %  |   ^  |   &  |   *  |   (  |   )  | Bksp |
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_PPPC,_______,KC_ALTKN,KC_GUIEI,KC_ENTRO,KC_ENTRO,KC_SPCRI,KC_SPCRI,KC_IMEON, KC_SSLEFT,_______, KC_SSRIGHT
),
[_RAISE] = LAYOUT_planck_grid(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
    _______,  _______,  _______,  _______, _______, KC_QUOT,KC_MINS,KC_EQL,KC_TILD,  KC_LBRC, KC_RBRC, KC_BSLS,
    _______, _______,  _______,  _______, _______, KC_DQUO, KC_UNDS,KC_PLUS,KC_SLSH, KC_LCBR, KC_RCBR, KC_PIPE,
     KC_PPPC,_______,KC_ALTKN,KC_GUIEI,KC_ENTRO,KC_ENTRO,KC_SPCRI,KC_SPCRI,KC_LOWEI, KC_SSLEFT,_______, KC_SSRIGHT
),
[_ICHIO] = LAYOUT_planck_grid(
    ...
    _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, _______, _______, _______, _______, KC_SSLEFT,_______, KC_SSRIGHT
),
//[_ICHIO] = LAYOUT_planck_grid(
//    _______, _______, _______,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD,  RGB_VAI, RGB_VAD, KC_DEL ,
//    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  _______,  KC_UP,  _______,  _______,
//    _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF, _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______,
//    RESET, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, _______, _______, _______, _______,  _______, _______, _______
//),
...
[_ADJUST] = LAYOUT_planck_grid(
    _______, _______, _______,   RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD,  RGB_VAI, RGB_VAD, KC_DEL ,
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  _______,  KC_UP,  _______,  _______,
    _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  TERM_ON, KC_LEFT, KC_DOWN, KC_RIGHT, _______,
